...
if IS_WINDOWS:
    ...
    class FolderMapping:
        ...
        def to_wsb_config(self) -> Dict:
            ...
            return {"HostFolder": str(self.host_path), "ReadOnly": self.read_only}
    ...
    class SandboxManager:
        ...
        def __init__(self, config: SandboxConfig):
            ...
            self.config.mappings.append(FolderMapping(self.shared_dir, read_only=False))
    ...
    def quantum_attribute_update(self, input_data: Dict[str, Any]) -> None:
        ...
        quantum_mapping = {
            "quantum_metadata": {
                ...
                "entanglement_pairs": lambda pairs: {
                    k: v for k, v in pairs.items() if isinstance(v, QuantumAtom)
                },
            }
        }
...
if __name__ == "__main__":
    from hermitian_microcode import HermitianAtom
